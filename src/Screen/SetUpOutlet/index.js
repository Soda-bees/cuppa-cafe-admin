  ...
  const handleSetupOutlet = async () => {
    try {
      ...
      const body = {
        ...
        description,
        openHours: `${startTimeHour}:${startTimeMinutes} ${amStart} - ${closingTimeHour}"${closingTimeMinutes} ${amClose}`,
      };
      ...
      console.log("Outlet created successfully ", response.data.message);
      const token = "authToken";
      dispatch(setAuthToken(token)) 
      navigate("/");
      
    } catch (error) {
      console.log("Failed to create outlet:  ", error.message);
    }
  };
    ...
    <div className={style.container}>
      <div className={style.logInBox}>
        ...
        <div className={style.boxRight}>
          ...
          <div className={style.uploadImgtext}>Upload Cover</div>
          <div className={style.textFeild}>
          ...
          <div className={style.textFeild}>
            ...
            >
              <div className={style.userIput}>
                {startTimeHour}:{startTimeMinutes} {amStart} - {closingTimeHour}{" "}
                : {closingTimeMinutes} {amClose}{" "}
              </div>
          ...
          <div className={style.btnWrapper} onClick={handleSetupOutlet}>
