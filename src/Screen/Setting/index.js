      ...
      <div className={style.menu}>
        ...
        <div className={style.settingWrapper}>
          <div className={style.settingLeft}>
            ...
            <div className={style.settingOption} onClick={handleLogout}>
              <div className={style.optionName}>
          ...
          <div className={style.settingRight}>
            ...
            <div className={style.InputFeild}>
              <div className={style.editinputWrapper}>
                <div className={style.lable}>Admin Name</div>
                <input
              ...
              <div className={style.editinputWrapper}>
                <div className={style.lable}>Email</div>
                <input
            ...
            <div className={style.div}>
              <div className={style.editinputWrapper}>
                <div className={style.lable}>Contact Number</div>
                <PhoneInput
                  value={value}
                  defaultCountry="US"
                  onChange={setValue}
              ...
              <div className={style.inputdiv}>
                <div className={style.lable}>location</div>
                <input
                  onChange={(e) => setEmail(e.target.value)}
                  className={style.editInput}
                  type="text"
