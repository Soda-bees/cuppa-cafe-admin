                    ...
                    <div className={style.addOffer}>
                        <div class={style.textFieldWrapper}>
                            <div className={style.textfield}>
                                ...
                                <input className={style.userInput} onChange={(e) => setOfferTitle(e.target.value)} />
                            </div>
                            <div className={style.textfield}>
                        ...
                        <div className={style.offerInfoWrapper}>
                            <div className={style.infoWrapper}>
                                <div className={style.description}>
                                    ...
                                    <textarea rows="20" cols="50" onChange={(e) => setOfferDescription(e.target.value)} className={style.userInput} ></textarea >
                                </div>
