...
export default function RewardDetail() {
  ...
  const [rewardName, setRewardName] = useState("Buy 5 Get 1 Free");
    ...
    <div className={style.container}>
      ...
      <div className={style.menu}>
        <div className={style.btnWrapper}>
          ...
          <div className={style.btn}>Create Reward</div>
        </div>
        <div className={style.rewardDetailWrapper}>
          <div className={style.rewardNameWrapper}>
            ...
            <div className={style.rewardsNameInfo}>{rewardName}</div>
          </div>
              ...
              >
                ...
                {dropDown && (
                  <div className={style.dropDownSelect}>
                    ...
                    onClick={() => setDropDown("Reward Item")}
                    >
                      {rewardItem.map((item, index) => (
                        <div key={index}
