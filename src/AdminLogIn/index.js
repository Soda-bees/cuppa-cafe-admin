        ...
        <div className={style.container}>
            <div className={style.logInBox}>
                ...
                <div className={style.boxRight}>
                    ...
                    <div className={style.logInPara}>Offering coffee shop owners a platform to enhance their sales with Cuppa.</div>
                    <div className={style.textFeild}>
                        <div className={style.inputHeading}>Username/Email</div>
                        <input className={style.userInput} type="text"  onChange={(e)=> setUserName(e.target.value)} />
                    </div>
                    <div className={style.textFeild}>
                    <div className={style.inputHeading}>Password</div>
                        <input className={style.userInput} type="text" onChange={(e)=> setUserPassword(e.target.value)} />
                    </div>
                    ...
                    <div className={style.lastPara} >
                        Don’t have an account?<span className={style.signUpBtn}>Sign Up Today!</span>
                    </div>
