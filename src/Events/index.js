  ...
  return (
    <div className={style.container}>
      <div className={style.menubar}>
        ...
        <div
          onClick={() => setIsSelect(!isSelected)}
          className={isSelected ? style.menuList : style.menuListTwo}
        >
          <img
            className={style.menuImg}
            src={isSelected ? images.menuIcon : images.menuGreenIcon}
          />
          Menu
        </div>
        <div className={style.menuList}>
      ...
      <div className={style.menu}>
        <div className={style.btnWrapper}>
          <div className={style.headingWrapper}>
            <div
              onClick={() => setbtn("upComing")}
              className={btn === "upComing" ? style.btn : style.btnTwo}
            >
              Upcoming Events
            </div>
            <div
              onClick={() => setbtn("past")}
              className={btn === "past" ? style.btn : style.btnTwo}
            >
              {" "}
              Past Events
            </div>
      ...
      >
        <div className={style.modalContainer}>
          <div className={style.ModalheadingWrapper}>
            ...
            <div className={style.heading}>Add Category</div>
