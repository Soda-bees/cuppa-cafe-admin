                ...
                <div className={style.addItemLeft}>
                    <div className={style.addItemDetails}>
                        ...
                        <div className={style.textFeild}>
                            ...
                            <div className={style.inputWrapper}>
                                ...
                                <textarea cols={"10"} rows={"5"} className={style.textInputTwo} onChange={(e) => setItenDescription(e.target.value)}></textarea>
                            </div>
                    ...
                    {todos.map((todo, index) => (
                        <div className={style.row} key={index} >
                            <div  onClick={() => deleteTodo(index)} className={style.circle}><div className={style.greenLine}></div></div>
                            <div><input className={style.textInputThree} type='text' onChange={(e) => handleTodoChange(index, 'size', e.target.value)} value={todo.size} /></div>
                            <div><input className={style.textInputThree} type='text' onChange={(e) => handleTodoChange(index, 'price', e.target.value)} value={todo.price} /></div>
                            <div><input className={style.textInputThree} type='text' onChange={(e) => handleTodoChange(index, 'serves', e.target.value)} value={todo.serves} /></div>
                        </div>
                    ))}

                    {/* <div className={style.row}>
                        <div className={style.circle}><div className={style.greenLine}></div></div>
                        <div><input className={style.textInputThree} type='text' onChange={(e) => setSize(e.target.value)} /></div>
                        <div><input className={style.textInputThree} type='text' onChange={(e) => setPrice(e.target.value)} /></div>
                        <div><input className={style.textInputThree} type='text' onChange={(e) => setServes(e.target.value)} /></div>
                    </div>
                    <div className={style.row}>
                        <div className={style.circle}><div className={style.greenLine}></div></div>
                ...
                <div className={style.addItemRight}>
                    ...
                    <div className={style.filteritem} >
                        ...
                        <div>
                            ...
                            {/* <div className={style.row}>
                                <div className={style.circle}><div className={style.greenLine}></div></div>
                                <div><input className={style.textInputFour} type='text' onChange={(e) => setFilterOptionTwo(e.target.value)} /></div>
                                <div><input className={style.textInputFour} type='text' onChange={(e) => setFilterOptionPriceTwo(e.target.value)} /></div>
                            </div>
                            <div className={style.row}>
                                <div className={style.circle}><div className={style.greenLine}></div></div>
                                <div><input className={style.textInputFour} type='text' onChange={(e) => setFilterOptionThree(e.target.value)} /></div>
                                <div><input className={style.textInputFour} type='text' onChange={(e) => setFilterOptionPriceThree(e.target.value)} /></div>
                            </div>
                            <div className={style.row}>
                                <div className={style.circle}><div className={style.greenLine}></div></div>
                                <div><input className={style.textInputFour} type='text' onChange={(e) => setFilterOptionfour(e.target.value)} /></div>
                                <div><input className={style.textInputFour} type='text' onChange={(e) => setFilterOptionPricefour(e.target.value)} /></div>
                            </div>
                            <div className={style.row}>
                                <div className={style.circle}><div className={style.greenLine}></div></div>
                                <div><input className={style.textInputFour} type='text' onChange={(e) => setFilterOptionFive(e.target.value)} /></div>
                                <div><input className={style.textInputFour} type='text' onChange={(e) => setFilterOptionPriceFive(e.target.value)} /></div>
                            </div> */}
                        </div>
                        ...
                        <div className={style.required}>
                            Make it required
                            <div className={style.owal}><div className={style.circleTwo}></div></div>
                        </div>
                        <div className={style.actionWrapper} >
                            <div className={style.actionHeading}>
                                Action
                            </div>
                            <div className={style.chooseWrapper}>
                                <div onClick={() => setChooseBtn(!chooseBtn)} className={chooseBtn ? style.chooseMany : style.chooseOne} >
                                    Choose One
                                </div>
                                <div onClick={() => setChooseBtn(!chooseBtn)} className={chooseBtn ? style.chooseOne : style.chooseMany}>
                                    Choose Many
                                </div>
                            </div>
